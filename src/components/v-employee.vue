               ...
               <div class="p-2 w-50 bd-highlight">
                     ...
                     <div class="input-group mb-3">
                        ...
                        <select class="form-select" v-model="Department">
                           <option v-for="(dep, i) in DEPARTMENTS" :key="i">
                           {{dep.DepartamentName}}
                           </option>
                        </select>
                     </div>
...
export default {
   ...
   data:()=>({
        ...
        Department:"",
        DateOfJoining:"",
        PhotoFileName:"IMG_4275.JPG",
        PhotoPath: 'http://localhost:34104/photos/',
   }),
   computed:{
   ...
   methods:{
      ...mapActions('depaartment', ['GET_DEPARTMENTS']),
      ...mapActions('employee', 
            ['GET_EMPLOYEES', 
            'CREATE_EMPLOYEE',
            'UPDATE_EMPLOYEE',
            'DELETE_EMPLOYEE_BY_ID',
            'UPLOAD_IMAGE_EMPLOYEE',
            ]),
      refreshData(){
      ...
      addClick(){
        ...
        this.Department="",
        this.DateOfJoining="",
        this.PhotoFileName="IMG_4275.JPG"
      },
      editClick(emp){
      ...
      createClick(){
         this.CREATE_EMPLOYEE({
            ...
            DataOfJoing:this.DateOfJoining,
      ...
      imageUpload(event){
         ...
         this.UPLOAD_IMAGE_EMPLOYEE(formData)
         .then(response =>{
            alert(response);
